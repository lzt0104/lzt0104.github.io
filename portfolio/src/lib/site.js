...
export const SECTIONS = [
  ...
  { id: 'awards',   label: '比賽', color: '#a8c6e6' },
...
export const TYPE_COLOR = {
  教學: '#f6c9d2', 自治: '#cfe6dc', 社群: '#c9e4f2', 志工: '#e6ecc4',
  研究: '#d6e3f3', 工作: '#f9e3a3', 榮譽: '#f5d0b0', 研習: '#e2d8ec',
};
...
export const facts = () => [
  ...
  { value: competitions.filter(c => c.result !== '參賽').length, label: '個獎項' },
